...
//todo!!!! refactor it to enum!!!
public class Colors {

    public  static HashMap<String, List<double[]>> COLORS_PALETTE = new HashMap<String, List<double[]>>();
    ...
    static {
        COLORS_PALETTE.put(YELLOW, Arrays.asList(
        ...
        COLORS_PALETTE.put(TAN_BEIGE, Arrays.asList(
        ...
        COLORS_PALETTE.put(RED, Arrays.asList(
...
//                new double[]{+49.41, +00.00, -08.00}
        ...
        COLORS_PALETTE.put(GRAY, Arrays.asList(
                new double[]{+57.00, -03.36, -04.97},
                new double[]{+62.00, -02.42, -04.37},
                new double[]{+65.00, +00.07, -01.00},
                new double[]{+48.00, -01.89, +00.65},
        ...
        COLORS_PALETTE.put(BROWN, Arrays.asList(
        ...
        COLORS_PALETTE.put(WHITE, Arrays.asList(
        ...
        COLORS_PALETTE.put(BLACK, Arrays.asList(
        ...
        COLORS_PALETTE.put(IVORY_CREAM, Arrays.asList(
        ...
        COLORS_PALETTE.put(PINK, Arrays.asList(
        ...
        COLORS_PALETTE.put(ORANGE, Arrays.asList(
        ...
        COLORS_PALETTE.put(GOLD, Arrays.asList(
