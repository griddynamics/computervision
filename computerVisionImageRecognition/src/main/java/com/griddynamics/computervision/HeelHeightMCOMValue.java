 ...
 */
public enum HeelHeightMCOMValue {
    ...
    HeelHeightMCOMValue(String mid, AttributeStrategy attributeStrategy) {
        this.value = mid;
        this.attributeStrategy = attributeStrategy;
    }

    HeelHeightMCOMValue(String mid, AttributeStrategy attributeStrategy, String exclusionCondition) {
        this.value = mid;
        this.attributeStrategy = attributeStrategy;
    ...
    public static HeelHeightMCOMValue getEnum(String value) {
        for (HeelHeightMCOMValue v : values())
