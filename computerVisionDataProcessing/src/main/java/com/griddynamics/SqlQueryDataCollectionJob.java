...
//            " where CATEGORY.CATEGORY_ID=5991";
    ...
    public static final String SELECT_QUERY = "select distinct\n" +
            ...
            " mod(PRODUCT_IMAGE.IMAGE_ID, %d) AS ID_MOD \n"+
            "\n" +
            "from PRODUCT_COLORWAY \n" +
            "  join PRODUCT_COLORWAY_IMAGE on PRODUCT_COLORWAY_IMAGE.PRODUCT_COLORWAY_ID = PRODUCT_COLORWAY.PRODUCT_COLORWAY_ID and  PRODUCT_COLORWAY_IMAGE.COLORWAY_IMAGE_ROLE_TYPE = 'CPRI'\n" +
            ...
            "  join CATEGORY on CATEGORY.CATEGORY_ID= PRODUCT.CATEGORY_ID \n"+
            "WHERE  CATEGORY.CATEGORY_ID in (%s) and  ROWNUM <= 1000 ";
...
//        jdbc:oracle:thin:@dml1-scan:1521/bpmstg01 //bcom
        ...
        for (final ICategory category : categoriesCollection) {
            ...
            imagesRecognitionResult.collect();
